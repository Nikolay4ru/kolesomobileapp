      ...
      if (isDirector) {
        ...
        if (statsData.success) {
          setStatistics({
            ...
            newOrdersCount: ordersData.orders?.filter(o => o.status === 'new').length || 0,
            processingOrdersCount: ordersData.orders?.filter(o => o.status === 'processing').length || 0,
            completedOrdersCount: ordersData.orders?.filter(o => o.status === 'completed').length || 0,
          });
        }
      } else {
